...
### Configuration file - you can also find this under ~/group/ref/WES/, that one might be more up to date!
...
params {
    ...
    max_cpus = 8
    max_time = 24.h
    igenomes_base = '/fast/work/groups/ag_romagnani/ref/WES/igenomes'
    genomes {
       'GATK.GRCh38' {
            ...
            intervals               = "/fast/work/groups/ag_romagnani/ref/WES/Twist_Exome_RefSeq_MitoPanel_hg38_target_sorted.bed"
...
### Run command
```
nextflow run nf-core/sarek -r 3.4.0 --input samplesheets/paired_samplesheet.csv --outdir outs/paired_outs --genome GATK.GRCh38 -profile apptainer -c ~/group/work/ref/WES/cubi.config --tools mutect2,strelka,vep --wes --only_paired_variant_calling
```
